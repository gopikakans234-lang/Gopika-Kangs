  ...
  return (
    ...
    <Section className="bg-navy-900 pt-0 md:pt-0 pb-12 md:pb-20">
      <div className="max-w-5xl mx-auto text-center">
        {/* Heading */}
        <motion.h2 
          className="text-2xl md:text-3xl lg:text-4xl font-extrabold text-white mb-5 tracking-tight leading-tight"
        ...
        <motion.p 
          className="text-lg md:text-xl lg:text-2xl text-text-muted leading-relaxed font-medium max-w-4xl mx-auto mb-10 md:mb-24"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
        ...
        {realityCheck.urgencyBox && (
          <motion.div 
            ...
            className="w-full max-w-3xl mx-auto bg-navy-800 border border-white/10 rounded-3xl p-5 md:p-8 text-left relative overflow-hidden shadow-2xl"
          ...
          >
            ...
            <h3 className="text-xl md:text-3xl font-bold text-white mb-5 relative z-10">
            ...
            <div className="space-y-4 relative z-10">
              {realityCheck.urgencyBox.items.map((item: any, index: number) => (
                <div key={index} className="flex items-start gap-3 md:gap-4">
                  ...
                  <p className="text-base md:text-xl text-text-muted/90 font-medium pt-2">
                    {item.text}
                  </p>
                </div>
              ))}
        ...
        {realityCheck.painReview && (
          <motion.div
            className="mt-12 md:mt-32 max-w-5xl mx-auto text-center"
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
