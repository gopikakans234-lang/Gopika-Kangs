...
export const Hero: React.FC<HeroProps> = ({ onCtaClick }) => {
  ...
  return (
    <Section className="min-h-[100dvh] md:min-h-[85vh] flex items-center justify-center pt-28 pb-12 md:pt-32 md:pb-20 relative overflow-hidden px-0">
      {/* Background Glows */}
      ...
      <div className="flex flex-col items-center text-center max-w-7xl mx-auto relative z-10 w-full px-4 sm:px-6">
        ...
        {/* Main Heading - Increased by one size level as requested */}
        <motion.h1 
        ...
        {/* Description Lines - Multi-line on mobile, single line on desktop as requested */}
        <motion.div 
        ...
        {/* Action Buttons */}
        <motion.div 
          className="flex flex-col sm:flex-row items-center justify-center gap-6 md:gap-10 w-full sm:w-auto"
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
