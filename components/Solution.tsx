...
export const Solution: React.FC<SolutionProps> = ({ onCtaClick, onQuizClick }) => {
  ...
  return (
    <Section id="solution" className="bg-navy-900 relative overflow-hidden pt-6 md:pt-12">
      ...
      <div className="w-full max-w-5xl mx-auto flex flex-col items-center relative z-10">
        ...
        <div className="flex justify-center mb-6 text-brand-green">
          <Map size={48} className="md:w-14 md:h-14" strokeWidth={1.5} />
        </div>
        ...
        <motion.h3 
           ...
           className="text-xl md:text-3xl font-bold text-brand-green uppercase tracking-wide mb-8 md:mb-10 text-center"
        >
        ...
        <motion.div 
          ...
          className="w-full max-w-4xl mx-auto flex flex-col gap-4 md:gap-6 text-left mb-12 md:mb-16"
        >
          {solution.phases.map((phase, index) => (
            ...
            >
              ...
              <div className="absolute left-0 top-0 bottom-0 w-1.5 md:w-2 bg-gradient-to-b from-brand-green to-blue-500 shadow-[0_0_15px_rgba(12,205,126,0.4)]" />
              
              <div className="p-5 pl-7 md:p-8 md:pl-12">
                <div className="flex flex-col items-start gap-1 md:gap-2 mb-2 md:mb-3">
                  <h3 className="text-lg md:text-2xl font-bold text-white group-hover:text-brand-green transition-colors">
                    {phase.phase}
                  </h3>
                  <span className="text-brand-green font-bold tracking-wide uppercase text-xs md:text-base">
                    {phase.title}
                  </span>
                </div>
